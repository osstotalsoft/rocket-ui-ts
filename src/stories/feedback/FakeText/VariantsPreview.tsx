...
const VariantsPreview = () => {
  return (
    <Grid container rowSpacing={2} columnSpacing={4}>
      ...
      <Grid size={{ sm: 3 }}>
        <Typography sx={{ textAlign: 'center' }}>{'circular '}</Typography>
        <FakeText variant={'circular'} width={80} height={80} />
      </Grid>
      <Grid size={{ sm: 3 }}>
        <Typography sx={{ textAlign: 'center' }}>{'rectangular '}</Typography>
        <FakeText variant={'rectangular'} height={80} />
      </Grid>
      <Grid size={{ sm: 3 }}>
        <Typography sx={{ textAlign: 'center' }}>{'rounded '}</Typography>
