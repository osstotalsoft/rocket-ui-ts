...
import { Bounce, Flip, ToastContainerProps as ToastContainerPropsBase, Slide, Zoom } from 'react-toastify'

export interface ToastContainerProps extends Omit<ToastContainerPropsBase, 'transition'> {
  /**
